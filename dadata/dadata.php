...
if($_POST) {
    ...
    $token = $_POST['token']; //"7c552551c48ae60cb4dbbfe4447bcb11b06c7619";
    $secret = $_POST['secret']; //"c912701026dcfaf4a262ebfea5748d1e2ab16759";
...
// Стандартизовать ФИО
    ...
    $token = $_GET['token']; //"7c552551c48ae60cb4dbbfe4447bcb11b06c7619";
    $secret = $_GET['secret']; //"c912701026dcfaf4a262ebfea5748d1e2ab16759";
